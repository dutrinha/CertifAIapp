// /src/pages/CprorTopicosPage.jsx (Versão 2.0 - Padronizada com a HomePage)
...
export default function CprorTopicosPage() {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      // ☆ MUDANÇA ☆
      await AsyncStorage.setItem('lastStudiedTrail', JSON.stringify({ name: 'Simulado C-PRO R' }));
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View>
            {/* ☆ MUDANÇA ☆ */}
            <Text style={styles.headerTitle}>Simulado C-PRO R</Text>
