// /src/pages/CpaTopicosPage.jsx (Versão 2.0 - Padronizada com a HomePage)
...
export default function CpaTopicosPage() {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      await AsyncStorage.setItem('lastStudiedTrail', JSON.stringify({ name: 'Simulado CPA' }));
  ...
  return (
    // =======================================================
    // 2. LAYOUT ATUALIZADO (Fundo cinza, header limpo)
    // =======================================================
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View>
            <Text style={styles.headerTitle}>Simulado CPA</Text>
        ...
        <ScrollView style={styles.mainContent} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
          ...
          <View style={styles.section}>
            ...
            {/* ======================================================= */}
            {/* 4. CARD DE CONFIGURAÇÕES (com sombra)                  */}
            {/* ======================================================= */}
            <View style={styles.card}>
              {/* Stepper de Questões */}
              <View style={styles.settingsRow}>
                ...
                {/* ======================================================= */}
                {/* 5. STEPPER ATUALIZADO (botões redondos)              */}
                {/* ======================================================= */}
              ...
              <View style={[styles.settingsRow, { flexDirection: 'column', alignItems: 'flex-start' }]}>
                ...
                {/* ======================================================= */}
                {/* 6. BOTÕES DE DIFICULDADE ATUALIZADOS (estilo "Chip")   */}
                {/* ======================================================= */}
        ...
        {/* ======================================================= */}
        {/* 7. FOOTER ATUALIZADO (Botão flutuante com sombra)      */}
        {/* ======================================================= */}
...
// =======================================================
// 8. ESTILOS COMPLETAMENTE REFEITOS
// =======================================================
const styles = StyleSheet.create({
  ...
  footerButton: { 
    ...
    justifyContent: 'center', 
    paddingVertical: 16, 
    borderRadius: 16, // Padrão de botão
    gap: 10,
    // Sombra no botão
